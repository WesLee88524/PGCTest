...
def make_parser():
    ...
    parser.add_argument("--use_pgc_virtual", dest="use_pgc_virtual", default=False, action="store_true", help="enable PGC virtual maintenance")
    parser.add_argument("--no_pgc_virtual", dest="use_pgc_virtual", action="store_false", help="disable PGC virtual maintenance")
